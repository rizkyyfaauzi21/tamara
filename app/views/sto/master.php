    ...
    <table id="sto-table" class="table table-bordered align-middle table-striped">
      ...
      <tbody>
        <?php if (empty($stoList)): ?>
          <tr>
            <td colspan="15" class="text-center text-muted">Belum ada STO</td>
          </tr>
        <?php else: ?>
            ...
            <tr>
              ...
              <td class="text-nowrap">
                ...
                <?php else: ?>
                  ...
                  // ADMIN_GUDANG => hanya boleh hapus jika BELUM_DIPILIH
                  if ($role === 'ADMIN_GUDANG' && $s['pilihan'] !== 'DIPILIH') {
                    $bolehHapus = true;
                  }

                  // KEPALA_GUDANG => boleh hapus apapun selama NOT_USED
                  if ($role === 'KEPALA_GUDANG') {
                    $bolehHapus = true;
                  }

                  // SUPERADMIN => boleh hapus apapun selama NOT_USED
                  if ($role === 'SUPERADMIN') {
                    $bolehHapus = true;
                  }
                  ?>
